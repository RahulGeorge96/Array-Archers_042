    ...
    <div className="maincontainerofabout">
      ...
      <div className="heroimagewithriderabout">
        ...
        <div>
          <div>
            <img
              style={{ borderRadius: "8px", height: "195px", width: "100%" }}
              src={aboutImage2}
            />
          </div>
          <div>
            <p style={{ marginBottom: "10px", marginTop: "5px" }}>
              In 1903, out of a small shed in Milwaukee, Wisconsin, four young
              men lit a cultural wildfire that would grow and spread across
              geographies and generations.{" "}
            </p>
            <p>
              Their innovation and imagination for what was possible on two
              wheels sparked a transportation revolution and lifestyle that
              would make Harley-Davidson the most desirable motorcycle and
        ...
        <div>
          ...
          <div>
            <p style={{ marginBottom: "10px", marginTop: "5px" }}>
              ...
              experience we deliver, like we have for over a century and will
      ...
      <div className="stayintouchwithwe">
        ...
        <div className="textandeverything">
          ...
          <p>
            {" "}
            <input type="checkbox" /> I have read the privacy policy and I agree
